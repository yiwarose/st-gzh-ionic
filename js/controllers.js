 angular.module('GZH.controllers',[])
.controller('StarterCtrl',function($scope,$rootScope,$ionicLoading,$ionicActionSheet,$ionicModal){
	
})
.controller('TabCtrl', function ($scope,$rootScope,$ionicLoading,$ionicActionSheet,$ionicModal) {
...
.controller('DealingCtrl', function ($scope,$rootScope,$ionicLoading,$ionicActionSheet,$ionicModal,$state) {
	//$scope.openSubPage = function(){
	//	$state.go("declarationInfomation",{ifHidden:true});
	//}
})
.controller('RecordCtrl', function ($scope,$rootScope,$ionicLoading,$ionicActionSheet,$ionicModal,$state) {
	//$scope.openSubPage = function(){
	//	$state.go("declarationInfomation",{ifHidden:false});
	//}
})
.controller('DeclarationInfoCtrl', function ($scope,$rootScope,$ionicLoading,$ionicActionSheet,$ionicModal,$stateParams) {
	$scope.ifHidden = $stateParams.ifHidden;
})
.controller('ExchangeCtrl', function ($scope,$rootScope,$ionicLoading,$ionicActionSheet,$ionicModal,$state) {
...
.controller('AccountInfoCtrl', function ($scope,$rootScope,$ionicLoading,$ionicActionSheet,$ionicModal) {
...
.controller('ServiceRelationCtrl', function ($scope,$rootScope,$ionicLoading,$ionicActionSheet,$ionicModal) {
	...
	$scope.openSubPage = function(param){
		if(param==1){
			$scope.val1 = true;
			$scope.val2 = false;
			$scope.icon1 = "icon ion-chevron-down";
			$scope.icon2 = "icon ion-chevron-right";
		}else if(param==2){
			$scope.val1 = false;
			$scope.val2 = true;
...
.controller('SetupCtrl', function ($scope,$rootScope,$ionicLoading,$ionicActionSheet,$ionicModal,$state) {
	//$scope.openModifyPage = function(){
	//	$state.go("modify");
	//}
})
.controller('ModifyCtrl', function ($scope,$rootScope,$ionicLoading,$ionicActionSheet,$ionicModal) {
    	        ...
    	        formatter: function (params) {
    	            ...
    	            for (var i = params.length - 1; i >= 0; i--) {
    	                if (params[i].value instanceof Array) {
    						...
    						res += '<br/>  最高 : ' + params[i].value[3];
    	                    res += '<br/>  收盘 : ' + params[i].value[1];
    						res	+= '<br/>  最低 : ' + params[i].value[2];
    	                }
    	                else {
    	                    res += '<br/>' + params[i].seriesName;
    	                    res += ' : ' + params[i].value;
    	    ...
    	    series : [
    	        {
    	            ...
    	            markPoint : {
    	                ...
    	                data : [
    	                    ...
    	                    {type : 'min', name: '最小值ֵ', symbolSize:5}
    	                ]
    	            },
    	            markLine : {
    	                symbol : 'none',
